...
class LeagueManagerLoader
{
	...
	function __construct()
	{
		...
		add_action( 'plugins_loaded', array(&$this, 'leaguemanager_api_init') );
	...
	function leaguemanager_api_init() {
		global $leaguemanager_api_league;
		
		require_once dirname( __FILE__ ) . '/class-leaguemanager-api-league.php';
    	$leaguemanager_api_league = new Leaguemanager_API_League();
    	add_filter( 'json_endpoints', array( $leaguemanager_api_league, 'registerRoutes' ) );
	}
