...
class LeagueManagerHandball extends LeagueManager
{
	...
	function __construct()
	{
		...
		add_filter( 'leaguemanager_import_matches_'.$this->key, array(&$this, 'customImportMatches'), 10, 3 );
	...
	function customImportMatches( $custom, $line, $match_id )
	{
		$halftime = explode("-", $line[8]);
		$overtime = explode("-", $line[9]);
		$penalty = explode("-", $line[10]);
		$custom[$match_id]['halftime'] = array( 'plus' => "", 'minus' => "" );
